          ...
          <div class="navbar-inner">
            <div class="container">
              <ul class="nav">
                ...
                <li  class="active"><a href="parent.html">Parents</a></li>
                <li><a href="teacher.html">Teachers</a></li>
                <li><a href="career.html">Career Advisor</a></li>
...
require('db.php'); // Holds all of our database connection information
	...
	$order = "SELECT * FROM parent ORDER BY id";  
...
echo("<tr><td>$data[0]</td><td>$data[1]</td></tr><br>"); 

 }  
	
	?>

<iframe width="650" height="345" src="//www.youtube.com/embed/Z8ONN8upKNg" frameborder="0" allowfullscreen></iframe>
</div>
<div class="span4">

  <p>A recent BBC article this week, explored the theme of how Silicon Valley can attract more women in the tech sector. The BBC World Service’s NewsHour gathered a group of female tech insiders to ask the question, “why isn’t there more women in Silicon Valley”? One factor that was cited, was education and the lack of female computer graduates. Another reason, was simply not enough numbers entering the tech sector and a high dropout rate. 
...
<img src="images/ebooks.png" alt="Books">
<br><br>
<ul style="list-style:none;">
...
<img src="images/news.png" alt="Books">
<br><br>
<ul style="list-style:none;">
...
<img src="images/games.png" alt="Books">
<br><br>
<ul style="list-style:none;">
